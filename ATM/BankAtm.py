...
class BankAcct(object):
    ...
    def __init__(self,pin):
        ...
        for key in self.DataBase:
            if self.__pin in self.DataBase[key] and name in self.DataBase[key]:
                ...
                self.__transac = self.DataBase[key][3]
                break
    ...
    def GetTransactions_history(self):
        trans = "\n".join(self.__transac)
        return f"Transactions:\n{trans}"
    
    def record_transaction(self, description):
        self.__transac.append(description)
    ...
    def Deposit(self,amnt):
        del self.__acct
        self.__bal += amnt
        self.record_transaction(f"Deposited ${amnt}")
    ...
    def WithDraw(self,amnt):
        ...
        self.record_transaction(f"Withdrew ${amnt}")
        self.__bal -= amnt
        return self._Processing()
    ...
    def Transfer(self,AcctNo,amnt):
        ...
        self.DataBase[self.AcctNo][2] = self.__bal
        self.record_transaction(f"Transferred ${amnt} to account number :{otherAcctNo}")
