...
class Bank(Frame):        
    ...
    def main(self):
        ...
        Label(self,text = "WELCOME TO ATM OUTLET",fg = "#ffa500",
    ...
    def UserOption(self):
        ...
        Button(self,text = "Deposit Cash",bg = "#66c9fa",fg = "#023b57",width = 40,height = 2,font = ("arial", "11", "bold"),
               activeforeground = "red",command = self.Deposit).grid(columnspan = 75,pady = 1)
        Button(self,text = "Withdraw Cash",bg = "#66c9fa",fg = "#023b57",width = 40,height = 2,font = ("arial", "11", "bold"),
               activeforeground = "red",command = self.Withdraw).grid(columnspan = 75,pady = 1)
        
        Button(self,text = "Transactions History",bg = "#66c9fa",fg = "#023b57",width = 40,height = 2,font = ("arial", "11", "bold"),
               activeforeground = "red",command = self.Transaction).grid(columnspan = 75,pady = 1)
        
        Button(self,text = "Balance Inquiry",bg = "#66c9fa",fg = "#023b57",width = 40,height = 2,font = ("arial", "11", "bold"),
               activeforeground = "red",command = self.balance).grid(columnspan = 75,pady = 1)
        Button(self,text = "Transfer Cash",bg = "#66c9fa",fg = "#023b57",width = 40,height = 2,font = ("arial", "11", "bold"),
               activeforeground = "red",command = self.Transfer).grid(columnspan = 75,pady = 1)
        
        Button(self,text = "Change Pin",bg = "#66c9fa",fg = "#023b57",width = 40,height = 2,font = ("arial", "11", "bold"),
               activeforeground = "red",command = self.ChangePin).grid(columnspan = 75,pady = 1)
        Button(self,text = "Delete Account",bg = "#66c9fa",fg = "#023b57",width = 40,height = 2,font = ("arial", "11", "bold"),
               activeforeground = "red",command = self.DelAccount).grid(columnspan = 75,pady = 1)
        
        Button(self,text = "Return Card",bg = "#66c9fa",fg = "#023b57",width = 40,height = 2,font = ("arial", "11", "bold"),
               activeforeground = "red",command = self.Cancel).grid(columnspan = 75,pady = 1)
    ...
    def Transaction(self):
            self.User("Transactions History")
            acct = BankAcct(self.k)
            bal = acct.GetTransactions_history()
            del acct
            messagebox.showinfo("Transactions History",bal)
            self.UserOption()
